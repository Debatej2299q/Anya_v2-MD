...
module.exports = {
     ...
     */
    botname: process.env.BotName || "ѕυвαяυ md",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ɖɛɮãTëJ",
     ...
     */
    ownername: process.env.Owner_Name || "⚡𝘿𝞢𝞑𝞓𝙏𝞢𝙅🍷",
    ownernumber: process.env.Owner_Number || "918761888106",
    instagramId: process.env.Insta || "NOT AVAILABLE NOW",

    /**
     * other details and parameters
     */
    author: process.env.Author || "👉🏻ɖɛɮ👈🏻",
    packname: process.env.PackName || " ✮͢𝑩𝒃𝒚, ː͢im⚡𝘿𝞢𝞑𝞓𝙏𝞢𝙅 🌸𝒆🪡🩵
...
｜　 _つ  +  —̳͟͞͞💗  —̳͟͞͞💗 ˚
`し´",
    socialLink: process.env.Web || "https://github.com/Debatej2299q",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/EDYe8Fto4PTJwRkC0ItRDF",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "rio2i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "aHhxcTR_Queen-Anya_ycGs=",
